// src/app/icons.ts
// Este archivo contiene los iconos SVG puros. Se prefieren los archivos TS para mejor integración en Angular.

// Mapeamos los nombres que usaste en React a sus respectivos strings SVG.
export const ICON_MAP = {
  // Ícono de Desarrollo/Trabajo (Equivalente a FaBriefcase)
  Briefcase: `
  ...
  // Ícono de Análisis/Tendencia (Equivalente a FaChartLine)
  TrendUp: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  // Ícono de Herramientas/Desarrollo (Equivalente a FaTools)
  Tools: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  // Ícono de Personas/RH (Equivalente a FaUsers)
  Users: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  // Ícono de Diseño/Creatividad (Equivalente a FaLightbulb)
  Lightbulb: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
